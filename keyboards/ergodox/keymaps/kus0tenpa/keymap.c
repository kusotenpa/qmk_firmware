 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LCtrl  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  | L/L2 |; / L1| Enter  |
 * |--------+------+------+------+------+------| Tab  |           | '"   |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| Down   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |  \|  |   ~` | LGui |                                       | Alt  |  ESC |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_NO         ,KC_NO,      KC_BSLS,  KC_GRV, KC_LGUI,
                                                        KC_NO,  KC_NO,
                                                              KC_HOME,
        ...
        // right hand
             ...
             KC_RBRC,    KC_Y,   KC_U,  KC_I,   KC_O,   KC_P,             KC_BSPC,
                          KC_H,   KC_J,  KC_K, LT(MDIA, KC_L), LT(SYMB, KC_SCLN), KC_ENT,
             KC_QUOT,     KC_N,   KC_M,  KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_DOWN,
                                  KC_LALT, KC_ESC, KC_NO,   KC_NO,      KC_NO,
             KC_NO,        CTL_T(KC_ESC),
             KC_PGUP,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_HASH,KC_DLR, KC_GRV, KC_LPRN,KC_RPRN,
       KC_TRNS,KC_PERC,KC_CIRC,KC_TILD,KC_LBRC,KC_RBRC,KC_TRNS,
          EPRM,KC_TRNS,KC_TRNS,KC_PPLS,KC_EQL,
                                       RGB_MOD,KC_TRNS,
                                               KC_TRNS,
